...
for required_path in \
  "${script_dir}/data/fbank/gigaspeech_cuts_M.jsonl.gz" \
  "${script_dir}/data/fbank/gigaspeech_cuts_DEV.jsonl.gz" \
  "${script_dir}/data/lang_bpe_500"
do
...
if first.num_features != 100:
    raise SystemExit(f"Expected 100-dim features for 24k, got {first.num_features}")
