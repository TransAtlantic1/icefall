...
recipe_dir="${repo_root}/egs/gigaspeech_16k/ASR"
validation_root_default="$(cd -- "${repo_root}/.." && pwd)/experiments/main_flow_validation/giga16k"
...
while [[ $# -gt 0 ]]; do
  case "$1" in
    ...
    --help)
      cat <<'EOF'
Usage: test/recipes/giga16k/run_smoke_train.sh [options]
