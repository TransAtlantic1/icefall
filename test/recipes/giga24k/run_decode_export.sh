...
while [[ $# -gt 0 ]]; do
  case "$1" in
    ...
    --help)
      cat <<'EOF'
Usage: test/recipes/giga24k/run_decode_export.sh [options]
...
Options:
  ...
  --exp-dir  ../experiments/main_flow_validation/giga24k/exp/smoke/zipformer_m_g0
  --export-root ../experiments/main_flow_validation/giga24k/exports
  --epoch 1
  --avg 1
EOF
      exit 0
...
echo "Decoded and exported 24k artifacts into ${EXP_DIR} and ${EXPORT_ROOT}"
