...
root = repo_root.parent / "experiments" / "main_flow_validation" / "giga24k"
required = [
    ...
    root / "workspace" / "data" / "manifests_resampled" / "24000",
...
if not exp_candidates:
    print("Missing GigaSpeech 24k exp dir under exp/smoke")
    sys.exit(1)
...
print(f"giga24k validation files look present in {exp_dir}")
